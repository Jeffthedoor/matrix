 ...
 * {@link frc.robot.lib.logging.DataLogger logging},
 * {@link frc.robot.lib.fault.FaultMonitor fault monitoring}, and loops with
 * varying
 ...
 * loops.
 *
 * Uses {@link frc.robot.lib.auto.Autonomous} to configure autonomous
 * commands. Also includes
 * self-testing support with
 * {@link frc.robot.lib.testing.SystemTestCommand}.
 */
public class LightningRobot extends TimedRobot {
     ...
     * 
     * @return the {@link frc.robot.lib.LightningContainer} for the robot.
     */
