...
public class AbsoluteFieldDrive extends Command
{
  ...
  public void execute()
  {
    ...
    // ChassisSpeeds desiredSpeeds = swerve.getTargetSpeeds(vX.getAsDouble(), vY.getAsDouble(), new Rotation2d(0));
    ...
    // Make the robot move
    swerve.drive(new Translation2d(vX.getAsDouble(), vY.getAsDouble()).times(Constants.DrivetrainConstants.MAX_SPEED), 2*heading.getAsDouble(), true);
